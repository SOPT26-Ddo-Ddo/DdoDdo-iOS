...
class MatchingResultVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.okButton.dropShadow(color: .black, offSet: CGSize(width: 0, height: 3), opacity: 0.16, radius: 6)
    ...
    func setLayout(){
        MatchingResultService.shared.loadMyManito(groupIdx!){ networkResult in
            ...
            case .success(let manitoData):
                ...
                //self.bigProfile = self.myManitoInfo
                
                
                
                DispatchQueue.main.async {
                    self.bigProfile.imageFromUrl(self.myManitoInfo?.profileImg, defaultImgPath: "big-profile-example")
